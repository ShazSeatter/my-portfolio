    ...
    return (
        <>
            <div id="about-me" className="w-3/4 ml-16" data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease-in">
                <h3 className="md:text-[2rem]/[4rem] text-[2.5rem] font-Sintony"><span className="about-heading"></span>ABOUT ME</h3>
                <h4 className="md:text-[3rem]/[4rem] font-Gloock">Recent gradute of CodeClan based in Aberdeen, Scotland.</h4>
                ...
                <p className="mt-9 font-bold border-b-2 border-transparent hover:border-black duration-300 cursor-pointer">CHECK OUT MY WORK</p>
            </div>
        </>
    )
}
