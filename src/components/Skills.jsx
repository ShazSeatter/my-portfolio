...
const Skills = () => {
    return (
        ...
        <div className="flex justify-center flex-wrap">
            ...
            <div className="flex space-x-14 mb-14">
                <img className="rounded-md w-24 h-24"src="https://user-images.githubusercontent.com/25181517/117447155-6a868a00-af3d-11eb-9cfe-245df15c9f3f.png" alt="" />
            ...
            {/* mongodb and node js */}
            <div className="flex space-x-14 mb-14">
                <img className="rounded-md w-24 h-24"src="https://user-images.githubusercontent.com/25181517/183568594-85e280a7-0d7e-4d1a-9028-c8c2209e073c.png" alt="" />
            ...
            {/* python and flask */}
            <div className="flex space-x-14 mb-14">
                <img className="rounded-md w-24 h-24"src="https://user-images.githubusercontent.com/25181517/183423507-c056a6f9-1ba8-4312-a350-19bcbc5a8697.png" alt="" />
            ...
            {/* postSQL and java */}
            <div className="flex space-x-14 mb-14">
                <img className="rounded-md w-24 h-24"src="https://user-images.githubusercontent.com/25181517/117208740-bfb78400-adf5-11eb-97bb-09072b6bedfc.png" alt="" />
            ...
            {/* tailwind and c#*/}
            <div className="flex space-x-14 mb-14">
                <img className="rounded-md w-24 h-24"src="https://user-images.githubusercontent.com/25181517/202896760-337261ed-ee92-4979-84c4-d4b829c7355d.png" alt="" />
            ...
            {/* unity and restAPI */}
            <div className="flex space-x-14 mb-14">
                <img className="rounded-md w-24 h-24"src="https://user-images.githubusercontent.com/25181517/193427941-9437dbbe-376f-40dc-9573-0ef5c02a26a7.png" alt="" />
